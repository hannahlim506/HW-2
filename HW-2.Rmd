...
ggplot(profs, aes(x=beauty, y=eval)) + 
  geom_point() +
  labs(title = "Professor's Physical Attractiveness vs. Course Evaluation Scores", x = "Attractiveness", y = "Course Evaluation Scores")
```
...
ggplot(avg_bike, aes(x=hr, y=mean, group=1)) + 
  ...
  labs(title = "Average Hourly Bike Rentals Across All Hours of the Day", x = "Hour of Day", y = "Average Bike Rentals")
```
...
ggplot(avg_bike_workingday, aes(x=hr, y=mean, group=1)) + 
  ...
  labs(title = "Average Hourly Bike Rentals 
       on Weekends v.s. Weekdays", x = "Hour of Day", y = "Average Bike Rentals per Hour of Day")
```
